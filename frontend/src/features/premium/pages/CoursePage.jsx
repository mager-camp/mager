// features/premium/pages/CoursePage.jsx
// Route: /premium/kursus/:slug
// Usage in router: <Route path="kursus/:slug" element={<CoursePage />} />
...
import { KURSUS_DETAIL } from "../constants/premiumData";
