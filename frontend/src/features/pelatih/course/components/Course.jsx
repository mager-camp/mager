...
import { useFreeCourses } from "../hooks/useCourse";
    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h2 className="text-xl font-bold text-[var(--text-dashboard)]">Daftar Modul FREE</h2>
            <p className="text-sm text-text-primary">Kelola kursus dan modul latihan bertipe FREE.</p>
          </div>
        </div>
      </div>
