...
export default function EditUserProfile({ user, onBack, onSave }) {
  ...
  return (
    <div className="bg-[#f8fafc] min-h-screen font-sans text-slate-800">
      <h1 className="text-3xl font-bold text-[#1e3240] mb-8">Edit Profile User</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          <div className="flex justify-center mb-6">
            <div className="relative w-28 h-28">
              <div className="w-full h-full bg-[#10b981]/10 rounded-full flex items-center justify-center border-2 border-slate-200 overflow-hidden shadow-inner bg-slate-100">
                {previewImage ? (
                  <img src={previewImage} alt="Preview Avatar" className="w-full h-full object-cover" />
                ) : (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
            <div className="flex flex-col gap-2">
              <label className="text-xs font-bold text-[#4a7ca3] uppercase tracking-wide">Nama Lengkap</label>
              <input
                type="text"
                required
            ...
            <div className="flex flex-col gap-2">
              <label className="text-xs font-bold text-[#4a7ca3] uppercase tracking-wide">Email</label>
              <input
                type="email"
                required
            ...
            <div className="flex flex-col gap-2">
              <label className="text-xs font-bold text-[#4a7ca3] uppercase tracking-wide">Nomor Telpon</label>
              <input
                type="text"
            ...
            <div className="flex flex-col gap-2">
              <label className="text-xs font-bold text-[#4a7ca3] uppercase tracking-wide">Status Akun</label>
              <select
            ...
            <div className="flex flex-col gap-2 relative">
              <label className="text-xs font-bold text-[#4a7ca3] uppercase tracking-wide">Password Baru</label>
