...
function KeunggulanTaktis() {
  return (
    <section className="w-full py-[60px] px-4 sm:px-6 lg:px-10 bg-white" id="section-keunggulan">
      <div className="animasi-saat-scroll mb-10 max-w-[1306px] mx-auto" id="keunggulan-header">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-[#133957] mb-3 leading-[1.2]">
          Keunggulan Taktis.
        </h2>
        <p className="text-base sm:text-lg font-normal text-[#4682A9] leading-[1.6] max-w-[600px]">
      ...
      <div className="max-w-[1306px] mx-auto">
        <div className="flex flex-col lg:flex-row gap-6 mb-6" id="keunggulan-baris-atas">
          <div
            className="animasi-saat-scroll tunda-scroll-1 group w-full h-auto lg:h-[300px] bg-white border border-[#E2E8F0] rounded-2xl p-6 sm:p-8 flex flex-col justify-between gap-6 transition-all duration-300 hover:shadow-[0_8px_30px_rgba(19,57,87,0.08)]"
            id="kartu-manajemen"
          >
            <div className="flex justify-between items-start gap-4">
              <div className="max-w-[70%] sm:max-w-[60%]">
                <h3 className="text-xl sm:text-2xl font-bold text-[#133957] mb-2 leading-[1.3]">
                  Manajemen Kalender
                </h3>
                <p className="text-sm sm:text-base font-normal text-[#4682A9] leading-[1.6]">
              ...
              <div className="shrink-0 opacity-70 transition-opacity duration-300 group-hover:opacity-100 w-12 h-12 sm:w-[72px] sm:h-[72px]" id="ikon-kalender">
                <img src={ikonTanggal} alt="Ikon kalender" className="w-full h-full" />
              </div>
            </div>

            {/* Visual kalender mingguan */}
            <div className="flex gap-2 w-full max-w-96 h-[66px] py-3 px-4 bg-[#F8FAFC] rounded-lg border border-[#E2E8F0] items-center" id="visual-kalender">
          ...
          {/* Kartu Alarm Pintar */}
          <div
            className="animasi-saat-scroll tunda-scroll-2 w-full lg:w-96 lg:min-w-[384px] h-auto lg:h-[300px] bg-[#D9E7F5] rounded-2xl p-6 sm:p-8 flex flex-col justify-between gap-6"
            id="kartu-alarm"
          >
            <div>
              <h3 className="text-lg sm:text-[22px] font-bold text-[#4178BF] tracking-[0.5px] mb-2">
                ALARM PINTAR
              </h3>
              <p className="text-sm sm:text-base font-normal text-[#133957] leading-[1.6]">
        ...
        <div
          className="animasi-saat-scroll w-full h-auto lg:h-[300px] bg-white border border-[#E2E8F0] rounded-2xl p-6 sm:p-8 flex flex-col lg:flex-row gap-8 lg:gap-10 items-center transition-all duration-300 hover:shadow-[0_8px_30px_rgba(19,57,87,0.08)]"
          id="kartu-periodisasi"
        >
          <div className="flex-1 w-full" id="periodisasi-kiri">
            <h3 className="text-xl sm:text-2xl font-bold text-[#133957] mb-2 leading-[1.3]">
              Periodisasi Premium
            </h3>
            <p className="text-sm sm:text-base font-normal text-[#4682A9] leading-[1.6] mb-6">
          ...
          <div className="flex-1 w-full flex justify-center items-end pb-2.5" id="periodisasi-kanan">
